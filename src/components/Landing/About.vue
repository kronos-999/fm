    ...
    <div class="relative mx-auto max-w-7xl px-6 pt-20 pb-12 lg:px-8 lg:py-20">
      ...
      <div class="relative lg:flex lg:items-center">
        ...
        <div class="relative lg:ml-10">
          <svg class="absolute top-0 left-0 h-36 w-36 -translate-x-8 -translate-y-24 transform text-indigo-200 opacity-50"
            ...
            <footer class="mt-8">
              <div class="flex">
                ...
                <div class="ml-4 lg:ml-0">
                  <div class="text-base font-medium text-gray-900">Stefan Kunnert</div>
                  <div class="text-base font-medium text-indigo-600">Großmeister der Alten Freien und Angenommenen Maurer von Deutschland</div>
              </div>
            </div>
          </footer>
        </blockquote>
